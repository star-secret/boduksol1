...
def splitList(contours_list, dot_list,
    ...
    if (dot_number == 3):
        ...
        list2 = [contours_list[1]] + [contours_list[2]] + [center]
        list3 = [contours_list[2]] + [contours_list[3]] + [center]
        list4 = [contours_list[3]] + [contours_list[4]] + [contours_list[5]] + [center]
        list5 = [contours_list[5]] + [contours_list[6]] + [center]
        list6 = [contours_list[6]] + [contours_list[7]] + [center]
        list7 = [contours_list[7]] + [contours_list[8]] + [contours_list[9]] + [center]
        list8 = [contours_list[9]] + [contours_list[10]] + [center]
        spliced_list = [list1, list2, list3, list4, list5, list6, list7, list8]

    elif(dot_number == 9):
        contours_list.insert(0, dot_list[0])
        contours_list.insert(3, dot_list[1])
        contours_list.insert(6, dot_list[2])
        list1 = [contours_list[0]] + [contours_list[1]] + [contours_list[11]] + [center]
        list2 = [contours_list[1]] + [contours_list[2]] + [center]
        list3 = [contours_list[2]] + [contours_list[3]] + [center]
        list4 = [contours_list[3]] + [contours_list[4]] + [contours_list[5]] + [center]
        list5 = [contours_list[5]] + [contours_list[6]] + [center]
        ...
        list7 = [contours_list[7]] + [contours_list[8]] + [contours_list[9]] + [center]
        list8 = [contours_list[9]] + [contours_list[10]] + [center]
        list9 = [contours_list[10]] + [contours_list[11]] + [center]

        spliced_list = [list1, list2, list3, list4, list5, list6, list7, list8, list9]
