...
enemy_size = enemy.get_rect().size      #이미지의 크기를 [가로,세로]형태로 받아옴
enemy_width = enemy_size[0]             #캐릭터의 가로 크기
enemy_height = enemy_size[1]             #캐릭터의 세로 크기
enemy_x_pos = (screen_width-enemy_width) /2       # 화면 가로 크기의 절반 크기에 해당하는 곳에 캐릭터의 x값이 위치
enemy_y_pos = screen_height - character_height*3         # 화면 세로 크기의 가장 아래에 캐릭터의 y값이 위치
