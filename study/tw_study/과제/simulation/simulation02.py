...
while True:
   ...
   # collisions = pygame.sprite.spritecollide(drone, block_group, False)
    if(pygame.sprite.collide_mask(antidrones[2],drone)):
        print("충돌")
        
    if(pygame.sprite.collide_mask(antidrones[1],drone)):
        print("충돌")
        
    if(pygame.sprite.collide_mask(antidrones[0],drone)):
        print("충돌")

    if(pygame.sprite.collide_mask(antidrones[3],drone)):
        print("충돌")
