...
hackseem =[
    hackseemsprite((400,400)),
    hackseemsprite((600,500))
]
...
for i in range(0,1,1):
    hackseem[i].mask = pygame.mask.from_surface(hackseem[i].user_image_normal)
hackseem_group = pygame.sprite.RenderPlain(*hackseem)
...
while True:
   ...
   # collisions = pygame.sprite.spritecollide(drone, antidrone_group, False)
